...
package org.lanqiao.examples.library.functional;
...
import javacommon.mapper.JsonMapper;
import javacommon.test.data.RandomData;
import javacommon.web.ErrorCode;
import javacommon.web.ErrorResult;
